...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        content_layout.setContentsMargins(0, 0, 0, 80)  # Fix the margin issue
        ...
        self.toggled = True  # Initialize the toggled variable before calling toggle_icon
        self.toggle_icon()  # Fix error by defining the function first
        ...
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.SpeechRecogText)
        self.timer.start(200)  # Reduced refresh rate to 200ms
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            ...
            MicButtonInitialized()  # Ensure function is called
        else:
            self.load_icon(GraphicsDirectoryPath('Mic_on.png'), 60, 60)
            MicButtonClosed()  # Ensure function is called
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.draggable = True  # Fix: Initialize draggable
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.draggable = True  # Add this line in the __init__ method
